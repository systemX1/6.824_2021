...
func TestRaftLogTruncate(t *testing.T) {
	...
	e = []LogEntry{
		{0, 1, 7835}, {1, 1, 1526}, {2, 1, 7896}, {3, 1, 9377}, {4, 1, 1172}, {5, 1, 9152}, {6, 1, 1246}, {7, 1, 2920}, {8, 1, 9545}, {9, 1, 6123}, {10, 1, 1930}, {11, 1, 3918}, {12, 1, 3136}, {13, 1, 6714}, {14, 1, 5853}, {15, 1, 1010}, {16, 1, 6034}, {17, 1, 9439}, {18, 1, 3049}, {19, 1, 4074}, {20, 1, 7182}, {21, 1, 3688}, {22, 6, 3688}, {23, 6, 3688}, {24, 10, 3688},
	}
	...
	e = []LogEntry{
		{9, 1, 7346114951392631761}, {10, 1, 1738741665562420248}, {11, 1, 6684187936943440122}, {12, 1, 8036592355440237559}, {13, 1, 8361368526235920682},
	}
	n = []LogEntry{
		{14, 1, 4360611029131970908}, {15, 1, 7400823843287529525}, {16, 1, 2489418614210817561}, {17, 1, 8519260016716978626}, {18, 1, 6993154974038825947}, {19, 1, 1008007605460300518}, {20, 1, 1774280318773226980}, {21, 1, 4617934639504924324}, {22, 1, 3015210891149567234}, {23, 1, 2534946382264358140}, {24, 1, 7008595092771287268}, {25, 1, 3753485396871821837},
	}
	rL.TruncateAppendTest(13, e, n)

	e = []LogEntry{
		{198, 1, 4002}, {199, 1, 4003}, {200, 1, 41}, {201, 1, 4103}, {202, 1, 4101}, {203, 1, 4100}, {204, 1, 4102},
	}
	n = []LogEntry{
		{201, 1, 4103}, {202, 1, 4101}, {203, 1, 4100},
	}
	rL.TruncateAppendTest(200, e, n)

	e = []LogEntry{
		{198, 1, 4002}, {199, 1, 4003}, {200, 1, 41}, {201, 1, 4103}, {202, 1, 4101}, {203, 1, 4100}, {204, 1, 4102}, {205, 1, 4103},
	}
	n = []LogEntry{
		{201, 1, 4103}, {202, 1, 4101}, {203, 1, 4100}, {204, 1, 4102},
	}
	rL.TruncateAppendTest(200, e, n)

	e = []LogEntry{
		{198, 1, 4002}, {199, 1, 4003}, {200, 1, 41}, {201, 1, 4103}, {202, 1, 4101}, {203, 1, 4100},
	}
	n = []LogEntry{
		{201, 1, 4103}, {202, 1, 4101}, {203, 1, 4100}, {204, 1, 4102},
	}
	...
	n = []LogEntry{
		{201, 1, 4103}, {202, 1, 4101}, {203, 2, 4100}, {204, 2, 4102},
	}
	rL.TruncateAppendTest(200, e, n)
}
...
func TestRaftCheckAppendEntries(t *testing.T) {
	...
	rL.Entries = []LogEntry{
		{0, 1, 2708}, {1, 1, 6094}, {2, 1, 4932}, {3, 1, 4447}, {4, 1, 6978}, {5, 1, 3823}, {6, 1, 5190}, {7, 1, 3398}, {8, 1, 612}, {9, 1, 3893}, {10, 1, 9642}, {11, 1, 8594}, {12, 1, 9648}, {13, 1, 742}, {14, 1, 4394}, {15, 1, 3312}, {16, 1, 8528}, {17, 1, 1564}, {18, 1, 7022}, {19, 1, 1365}, {20, 1, 8981}, {21, 1, 5553}, {22, 12, 5553},
	}
